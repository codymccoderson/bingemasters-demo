...
import ClassicEasy from './ClassicEasy';
import ClassicMedium from './ClassicMedium';
import ClassicHard from './ClassicHard';
...
class SelectDifficultyClassic extends React.Component {
...
export default SelectDifficultyClassic;